...
int boyer_moore (char *string, int stringlen, char *pat, int patlen) {
    int i;
    ...
    while (i < stringlen) {
        ...
        i += max(delta1[(int)(string[i])], delta2[j]);
    }
    free(delta2);
    return -1;
}
...
int main (int argc, char const* argv[])
{
    ...
    ans = boyer_moore(s, strlen(s), t, strlen(t));
    printf("%d\n", ans);
